...
public class BkCategoryDaoTest {
    ...
    /**
     * Verifies gets all BkCategorys successfully.
     */
    @Test
    void getAllBkCategorysSuccess(){
        List<BkCategory> bkCategorys = bkCategoryDao.getAll();
        assertEquals(6,bkCategorys.size());
    }
    /**
...
//     */
//    @Test
//    void updateBkCategorySuccess() {
//        String newTitle = "Horror";
//        BkCategory bkCategoryToUpdate = (BkCategory)bkCategoryDao.getById(2);
//        bkCategoryToUpdate.setTitle(newTitle);
//        bkCategoryDao.saveOrUpdate(bkCategoryToUpdate);
//        BkCategory retrievedBkCategory = (BkCategory)bkCategoryDao.getById(2);
...
//        List<BkCategory> bkCategorys = bkCategoryDao.getByPropertyEqual("title", "Comedy");
//        assertEquals(1, bkCategorys.size());
//        assertEquals(3, bkCategorys.get(0).getBkCategoryId());
//    }
//
//    /**
...
//        List<BkCategory> bkCategorys = bkCategoryDao.getByPropertyLike("title", "c");
//        assertEquals(2, bkCategorys.size());
//    }
//
//    /**
